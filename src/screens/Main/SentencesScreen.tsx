    ...
    try {
      ...
      try {
        ...
        if (sentencesFromService && sentencesFromService.length > 0) {
          ...
          const currentLanguage = language || 'russian'; // По умолчанию русский
          console.log("Current language for sentences:", currentLanguage);
          ...
          const formattedSentences = sentencesFromService.map((sentence: any) => {
            ...
            const translation = sentence[currentLanguage.toLowerCase()] || sentence.russian;

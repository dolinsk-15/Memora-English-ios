...
const SuperwallReactNative = NativeModules.SuperwallReactNative ? NativeModules.SuperwallReactNative : new Proxy({}, {
  get() {
...
export default class Superwall {
  ...
  eventEmitter = new NativeEventEmitter(SuperwallReactNative);
  static configEmitter = new EventEmitter();
  ...
  constructor() {
    ...
    this.eventEmitter.addListener('paywallWillOpenURL', async data => {
      ...
      const url = new URL(data.url);
      (_Superwall$delegate10 = Superwall.delegate) === null || _Superwall$delegate10 === void 0 || _Superwall$delegate10.paywallWillOpenURL(url);
    });
    this.eventEmitter.addListener('willRedeemLink', async () => {
      var _Superwall$delegate11;
      (_Superwall$delegate11 = Superwall.delegate) === null || _Superwall$delegate11 === void 0 || _Superwall$delegate11.willRedeemLink();
    });
    this.eventEmitter.addListener('didRedeemLink', async data => {
      var _Superwall$delegate12;
      const result = RedemptionResults.fromJson(data);
      (_Superwall$delegate12 = Superwall.delegate) === null || _Superwall$delegate12 === void 0 || _Superwall$delegate12.didRedeemLink(result);
    });
  }
  ...
  async confirmAllAssignments() {
    ...
    return assignments.map(assignment => Assignment.fromJson(assignment));
  }
